...
\cvachievement{\faCode}{Competitive programmer}{ 
  As part of my training for the ICPC contest, but also as a hobby usually I participate in most of the most famous competitive platforms like (Codeforces , CodeChef , LeetCode)
   being part of the top 1\% worldwide in some of them competing with more than 100k active users, Other rankings: \href{https://clist.by/coder/BetoSCL/}{Various rankings}}
\divider
% \switchcolumn
...
\cvachievement{\faChalkboardTeacher}{Teacher}{ 
  ...
  to attend the ICPC competition and find a place in the regional finals, I also used to publish solutions
  solutions to algorithmic challenges at \href{https://leetcode.com/BetoSCL/}{LeetCode}.
}
